...
public class MarioWorld {
    ...
    private ArrayList<Integer> marioActions;
    private ArrayList<Location> marioLocations;
    ...
    public MarioWorld(MarioEvent[] killEvents) {
        ...
        this.marioActions = new ArrayList<>();
        this.marioLocations = new ArrayList<>();
    ...
    public ArrayList<Integer> getMarioActions() {
        return this.marioActions;
    }

    public ArrayList<Location> getMarioLocations() {
        return this.marioLocations;
    }
    ...
    public void update(boolean[] actions) {
        ...
        Integer marioAction = 0;
        for(Boolean action : actions) {
            marioAction = marioAction << 1;
            if(action) {
                marioAction += 1;
            }
        }
        this.marioActions.add(marioAction);
        ...
        marioLocations.add(new Location(mario.x, mario.y));
    }
